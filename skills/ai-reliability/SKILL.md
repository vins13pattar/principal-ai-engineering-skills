...
| An evaluation reports a few points of improvement | Report the interval and the set's smallest detectable delta, and treat anything under it as unmeasured | "Publish the eval set's smallest detectable delta beside its accuracy." At an 85 % baseline, 50 examples per arm resolve nothing below about 20 points at 95 % confidence and 80 % power |
